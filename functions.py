...
def fight(mainc, attacker):
  ...
  while mainc.alive and attacker.alive:
    ...
    if mainc.color == "red": 
      userinput2 = input("1 for attack, 2 for health, 3 for TP, 4 for magic(XStab, req. 24 tp.).")
...
def magic(mainc, attacker):
  if mainc.color == "red":
     magicial_input = input("1 for XStab, req 24 TP.")
  elif mainc.color == "yellow":
     magicial_input = input("1 for shot, 2 for big shot.")
